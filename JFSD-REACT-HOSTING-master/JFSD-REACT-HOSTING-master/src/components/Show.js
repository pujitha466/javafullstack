...
export default function Show(){
    ...
    function Deletefun (email) {
        axios.delete("https://jfsd-production-c75d.up.railway.app/delete", {params:{
            email: email
        }}).then((res)=>{
            alert(res.data);
            setResult(null)
    ...
    function saveEdit() {
        axios.put("https://jfsd-production-c75d.up.railway.app/update", {
    ...
    if(result == null) {
        axios.get("https://jfsd-production-c75d.up.railway.app/all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
